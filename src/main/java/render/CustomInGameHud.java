...
public class CustomInGameHud extends InGameHud {
   ...
   private static final Identifier AIR_EMPTY_TEXTURE = new Identifier("hud/air_empty");
   ...
   public static final Identifier NAUSEA_TEXTURE = new Identifier("textures/misc/nausea.png");
